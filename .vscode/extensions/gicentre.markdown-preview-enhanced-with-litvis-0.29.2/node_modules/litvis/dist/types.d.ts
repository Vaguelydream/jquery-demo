...
export declare type ProcessedLitvisContextStatus = ProgramResultStatus;
...
/** visual */
 | "v";
export declare type BlockOutputFormat = OutputFormat
/** literate */
 | "l";
...
export interface LitvisDocument extends VFile {
    data: {
        ...
        litvisElmDependencyVersions?: {
            [packageName: string]: string | false;
        };
        litvisElmDependencyPositions?: {
            [packageName: string]: Position;
        };
...
export declare type ProcessedLitvisContext = SucceededLitvisContext | FailedLitvisContext;
